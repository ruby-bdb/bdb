...
VALUE env_txn_begin(VALUE obj, VALUE vtxn_parent, VALUE vflags)
{
  ...
  if ( ! NIL_P(vtxn_parent) ) {
    ...
    if (!parent->txn)
        rb_raise(0, "parent txn is closed");
  }
